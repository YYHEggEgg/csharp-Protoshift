...
#endregion
BasicCodeWriter fi_askCmdId = new("./../OldProtoHandlers/AskCmdId.cs");
...
#endregion
fi_askCmdId = new("./../NewProtoHandlers/AskCmdId.cs");
fi_askCmdId.WriteLine("// <auto-generated>");
fi_askCmdId.WriteLine("//     Generated by csharp-Protoshift.HandlerGenerator. DO NOT EDIT!");
fi_askCmdId.WriteLine("// </auto-generated>");
fi_askCmdId.WriteLine();
...
var supportedCmdIds = from cmdPair in oldcmdids.Intersect(newcmdids)
                      where supportedMessages.Contains(cmdPair.messageName)
                      select cmdPair;
#endregion
Console.ReadLine();