...
namespace NewProtos {
  ...
  public static partial class InMessageReflection {
    ...
    static InMessageReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            "Cg9Jbk1lc3NhZ2UucHJvdG8iKQoJSW5NZXNzYWdlEg4KBmluX3N0chgBIAEo",
            "CRIMCgRjb2RlGAIgASgNQgyqAglOZXdQcm90b3NiBnByb3RvMw=="));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          new pbr::FileDescriptor[] { },
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::NewProtos.InMessage), global::NewProtos.InMessage.Parser, new[]{ "InStr", "Code" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    public static pbr::MessageDescriptor Descriptor {
      get { return global::NewProtos.InMessageReflection.Descriptor.MessageTypes[0]; }
    }
    ...
    public int CalculateSize() {
      int size = 0;
      if (InStr.Length != 0) {
        size += 1 + pb::CodedOutputStream.ComputeStringSize(InStr);
      }
      if (Code != 0) {
