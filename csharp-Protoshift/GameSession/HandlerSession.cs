...
namespace csharp_Protoshift.GameSession
{
    internal class HandlerSession
    {
        ...
        public ConcurrentBag<TimeRecord> TimeRecords { get; }

        public struct TimeRecord
        {
            public string protoname;
            public bool fromClient;
            public long handleMilliseconds;
            public int packetSize;
        }

        private void SubmitTimeRecord(string protoname, bool isNewCmdid, long handleMilliseconds, int packetSize)
        {
            TimeRecords.Add(new TimeRecord { protoname = protoname, fromClient = isNewCmdid, 
                handleMilliseconds = handleMilliseconds, packetSize = packetSize });
        }

        // Generated by ChatGPT, not tested
        // Need EPPlus nuget reference
        public static void ExportXlsxRecord(List<TimeRecord> records, string filePath)
        {
