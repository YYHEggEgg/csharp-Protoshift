            ...
            : ISpecialOuterSkillIssueFixer<NewProtos.AbilityInvokeEntry, OldProtos.AbilityInvokeEntry>
    {
        ...
        public byte[] Handle(byte[] data, bool isNewCmdid)
        {
            if (isNewCmdid)
            {
                ...
                SkillIssueDetect.StartHandleNewPacketWithoutRecord("ClientAbilitiesInitFinishCombineNotify",
                    "ClientAbilitiesInitFinishCombineNotifyOuterFix(Client)",
            ...
            else
            {
                ...
                SkillIssueDetect.StartHandleOldPacketWithoutRecord("ClientAbilitiesInitFinishCombineNotify",
                    "ClientAbilitiesInitFinishCombineNotifyOuterFix(Server)",
