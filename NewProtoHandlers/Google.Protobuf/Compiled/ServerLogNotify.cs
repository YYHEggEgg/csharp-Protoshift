...
namespace NewProtos {
    ...
    static ServerLogNotifyReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "Z0xldmVsEiAKCGxvZ190eXBlGAkgASgOMg4uU2VydmVyTG9nVHlwZUIMqgIJ",
            "TmV3UHJvdG9zYgZwcm90bzM="));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          new pbr::FileDescriptor[] { global::NewProtos.ServerLogLevelReflection.Descriptor, global::NewProtos.ServerLogTypeReflection.Descriptor, },
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::NewProtos.ServerLogNotify), global::NewProtos.ServerLogNotify.Parser, new[]{ "ServerLog", "LogLevel", "LogType" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    public static pbr::MessageDescriptor Descriptor {
      get { return global::NewProtos.ServerLogNotifyReflection.Descriptor.MessageTypes[0]; }
    }
    ...
    private global::NewProtos.ServerLogLevel logLevel_ = global::NewProtos.ServerLogLevel.None;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public global::NewProtos.ServerLogLevel LogLevel {
    ...
    private global::NewProtos.ServerLogType logType_ = global::NewProtos.ServerLogType.None;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public global::NewProtos.ServerLogType LogType {
      get { return logType_; }
      set {
        logType_ = value;
      }
    ...
    public override int GetHashCode() {
      ...
      if (LogLevel != global::NewProtos.ServerLogLevel.None) hash ^= LogLevel.GetHashCode();
      if (LogType != global::NewProtos.ServerLogType.None) hash ^= LogType.GetHashCode();
    ...
    #else
      if (LogLevel != global::NewProtos.ServerLogLevel.None) {
        output.WriteRawTag(40);
        output.WriteEnum((int) LogLevel);
      }
      if (LogType != global::NewProtos.ServerLogType.None) {
    ...
    public void MergeFrom(ServerLogNotify other) {
      ...
      if (other.LogLevel != global::NewProtos.ServerLogLevel.None) {
        LogLevel = other.LogLevel;
      }
      if (other.LogType != global::NewProtos.ServerLogType.None) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          default:
            ...
            break;
          case 40: {
            LogLevel = (global::NewProtos.ServerLogLevel) input.ReadEnum();
            break;
          }
          case 72: {
            LogType = (global::NewProtos.ServerLogType) input.ReadEnum();
            break;
          }
          case 90: {
