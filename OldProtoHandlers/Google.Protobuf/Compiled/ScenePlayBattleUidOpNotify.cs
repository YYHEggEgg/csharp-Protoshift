  ...
  static ScenePlayBattleUidOpNotifyReflection() {
    byte[] descriptorData = global::System.Convert.FromBase64String(
        string.Concat(
          ...
          "EgoKcGFyYW1fbGlzdBgPIAMoDRIPCgdwbGF5X2lkGAUgASgNQh4KHGVtdS5n",
          "cmFzc2N1dHRlci5uZXQub2xkcHJvdG9iBnByb3RvMw=="));
    descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
        new pbr::FileDescriptor[] { },
        new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
          new pbr::GeneratedClrTypeInfo(typeof(global::ScenePlayBattleUidOpNotify), global::ScenePlayBattleUidOpNotify.Parser, new[]{ "Op", "ParamTargetList", "EntityId", "ParamStr", "UidList", "ParamIndex", "PlayType", "ParamDuration", "ParamList", "PlayId" }, null, null, null, null)
        }));
  }
  #endregion
