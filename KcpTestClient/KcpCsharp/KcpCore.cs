            ...
            lock (snd_bufLock)
            {
                ...
                foreach (var item in snd_buf)
                {
                    ...
                    if (needsend)
                    {
                        ...
                        var encodeRes = segment.Encode(buffer.Memory.Span.Slice(offset));
                        Console.WriteLine($"encodeREs: {encodeRes}, offset: {offset}");
                        offset += encodeRes;
